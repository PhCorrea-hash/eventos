...
SECRET_KEY = os.environ.get('SECRET_KEY', 'chave-secreta-padrao-segura')
...
# Essas duas linhas dizem ao django-allauth qual é o seu Client ID/Secret do Google
...
LOGIN_REDIRECT_URL = 'area'  # ou outra view
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv('DATABASE_URL'),  # precisa existir
        conn_max_age=600,
